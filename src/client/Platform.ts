...
// terron: запущены ли мы как НАТИВНОЕ приложение (Capacitor, iOS/Android из
// App Store), а не как сайт в браузере. Используется, чтобы прятать в магазинном
// приложении dev/бета-контролы и клавиатурные подсказки (Apple Guideline 2.2/4);
// на сайте в браузере всё остаётся как есть.
