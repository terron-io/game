...
export class MapPicker extends LitElement {
  ...
  // terron: «Случайная» — обычная плитка В сетке карт (не отдельная категория).
  // Выбирает рандомную карту при старте; визуально как карта-карточка.
