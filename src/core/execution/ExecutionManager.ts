...
import { SpawnGraceAutoExecution } from "./SpawnGraceAutoExecution";
...
export class Executor {
  ...
  createExec(intent: StampedIntent): Execution {
    ...
    switch (intent.type) {
      ...
      case "air_assault": // terron: авиация — воздушная высадка
        return new AirborneAssaultExecution(player, intent.dst, intent.troops);
      ...
      case "build_unit":
        return new ConstructionExecution(
          ...
          intent.troops, // terron: ультимейты — вклад войск в Раскол
          intent.dstTile, // terron: «Перенос» Шагающего города (второй тайл)
        );
      ...
      case "choose_ultimate": // terron: ультимейты-пассив (Реваншизм)
        return new ChooseUltimateExecution(player, intent.unit);
      default:
