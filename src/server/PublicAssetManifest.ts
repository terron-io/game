...
const ROOT_PUBLIC_FILES = new Set([
  "LICENSE",
  "ads.txt",
  "account-delete.html", // terron: удаление аккаунта (/account/delete)
  "debug.html", // terron: зонд-диагностика графики (/debug) — вне бандла намеренно
  "password-login.html", // terron: вход по логину/паролю (/account/password)
  "privacy-policy.html",
  "robots.txt",
