...
Additional Terms placed there by OpenFront LLC — applies in full and is
unmodified.

## Scope

The terms in this file are **additional terms under AGPL-3.0 Section 7**, and they
apply **only to the material added by TERRON.io** to this work — not to the
...
in reasonably visible locations such as the footer, loading screen, splash
screen, main menu, or a credits page linked from them — alongside, not instead
of, the upstream notices:
...
> Note: no license — neither AGPL nor MIT — grants rights to names or logos.
> Trademarks are separate from copyright. This clause states explicitly what is
> already the case.

## Removing these terms

As AGPL-3.0 Section 7 provides, a recipient may remove these additional terms
from a copy — but only together with the material they cover. Keeping
TERRON-contributed material means keeping the notice above.
